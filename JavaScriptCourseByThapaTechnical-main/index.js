...
/*
Double equal(==) checks for value equality onplay. Before checking the values, it converts the types of the variables to 
match each other.

Where as Triple equal(===) will verify whether the variables being compared have both the same value and the same type.
*/
...
// 1: array include 
// const colorss = ['red', 'green', 'blue', 'white', 'pink'];
// const isPresent = colorss.includes('purple');
